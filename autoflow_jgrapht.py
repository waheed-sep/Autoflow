...
REPO = r"/home/waheed/Univaq/assigned_tasks/jgrapht"
RESULTS_OUTPUT = "/home/waheed/Univaq/assigned_tasks/Final-Results/JGRAPHT-Results"  # Store all results (json, csv, jmh)
...
JMH_DIR = "/home/waheed/Univaq/JMH_JGrapht"
...
MAVEN_INSTALL_CMD = [
    ...
    "-DgroupId=org.jgrapht",
    "-DartifactId=jgrapht-core",
    "-Dversion=waheed",
    "-Dpackaging=jar",
]
