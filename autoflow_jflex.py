...
REPO = r"/home/waheed/Univaq/assigned_tasks/jflex"
RESULTS_OUTPUT = "/home/waheed/Univaq/assigned_tasks/Final-Results/JFLEX-Results"  # Store all results (json, csv, jmh)
...
JMH_DIR = "/home/waheed/Univaq/JMH_Jflex"
...
if not filtered_commits:
    ...
    for commit_hash in filtered_commits:
        ...
        try:
            ...
            target_dir = os.path.join(REPO, "jflex/target")
